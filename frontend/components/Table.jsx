const Table = () => {
  return (
    <section className="w-[90%] lg:w-[87%] mx-auto py-10 space-y-8">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="bg-white p-4 lg:p-6 rounded-[.5rem] space-y-2 shadow">
      ...
      <div className="bg-white p-4 lg:p-6 rounded-[.5rem] shadow space-y-2">
        <h3 className="text-[1rem] lg:text-[1.2rem] font-medium text-black">
          Functional Safety Studies
        </h3>
